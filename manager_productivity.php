...
<head>
    ...
    <script>
        function handleEvaluationTypeChange(value) {
            ...
            employeeDropdown.style.display = (value === 'Manager to Employee') ? 'block' : 'none';
...
<div class="container">
    <div class="header">
        <h1><i class="fas fa-chart-line"></i> Performance Evaluation</h1>
        <p>Comprehensive productivity assessment tool</p>
    </div>
        ...
        <form action="submit_evaluation.php" method="POST">
            ...
            <div class="section">
                ...
                <div class="rating-legend">
                    ...
                    <div class="legend-item">
                        <div class="legend-circle" style="background: #667eea; border-color: #667eea;"></div>
                ...
                <table class="criteria-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php endfor; ?>
                            <td>
                                <input type="text" name="comment[<?= $index ?>]" class="comment-input" placeholder="Add your comments here...">
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
